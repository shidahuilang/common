...
curl -fsSL https://raw.githubusercontent.com/shidahuilang/common/main/Custom/FinishIng.sh > $BASE_PATH/etc/init.d/FinishIng
if [[ $? -ne 0 ]]; then
  wget -P $BASE_PATH/etc/init.d https://raw.githubusercontent.com/shidahuilang/common/main/Custom/FinishIng.sh -O $BASE_PATH/etc/init.d/FinishIng
fi
